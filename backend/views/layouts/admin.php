...
//         $menuItems[] = ['label' => '库存调动', 'url' => ['appointment/store-stock']];
        $menuItems[] = ['label' => '用户列表', 'url' => ['/user/index']];
        $menuItems[] = ['label' => '预约核销', 'url' => ['/appointment/index']];
//         $menuItems[] = ['label' => '微信配置', 'url' => ['/wechat/index']];
        $menuItems[] = ['label' => '奖品配置', 'url' => ['/prize/index']];
        $menuItems[] = ['label' => '抽奖配置', 'url' => ['/rule/index']];
        $menuItems[] = ['label' => '门店配置', 'url' => ['/store/index']];
        $menuItems[] = ['label' => '日记', 'url' => ['/log/index']];
        $menuItems[] = '<li>'
